...
import GoldBtn from "../components/GoldBtn";// src/pages/LoginPage.jsx
...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg," + BLACK + " 0%,#1A1400 60%,#2C1F00 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      <div style={{ background: "rgba(255,255,255,0.04)", border: "1.5px solid " + (locked ? RED : GOLD_DIM), borderRadius: 24, padding: 36, maxWidth: 340, width: "100%", textAlign: "center", boxShadow: "0 8px 40px rgba(0,0,0,0.6)", transition: "border-color 0.3s" }}>
        ...
        {locked ? (
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              className={shake ? "shake" : ""}
              style={{ width: "100%", borderRadius: 10, border: "1.5px solid " + (error ? RED : GOLD_DIM), background: "rgba(255,255,255,0.06)", padding: "13px 14px", fontSize: 24, textAlign: "center", letterSpacing: "0.4em", boxSizing: "border-box", fontFamily: "inherit", outline: "none", color: WHITE, marginBottom: 8, transition: "border-color 0.2s" }}
            />
